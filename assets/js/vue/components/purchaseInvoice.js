            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        ...
                        <strong>Memo No.:</strong> {{ purchase.PurchaseMaster_MemoNo }}<br>
        ...
        async print(){
            ...
            printWindow.document.write(`
                ...
                <body>
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-2"><img src="/uploads/company_profile_thum/${this.currentBranch.Company_Logo_thum}" alt="Logo" style="height:60px;width:auto" /></div>
