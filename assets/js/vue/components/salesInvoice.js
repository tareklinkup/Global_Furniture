const salesInvoice = Vue.component("sales-invoice", {
  template: `
        <div>
            <div class="row">
                <div class="col-xs-6">
                    <a href="" v-on:click.prevent="printWithSeal"><i class="fa fa-print"></i> Print With Seal</a>
                </div>
                <div class="col-xs-6 text-right">
                <a href="" v-on:click.prevent="printWithOutSeal"><i class="fa fa-print"></i> Print WithOut Seal</a>
            </div>
            </div>
