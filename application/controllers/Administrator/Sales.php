...
class Sales extends CI_Controller
{
    ...
    public function addSales()
    {
        ...
        try {
            ...
            $sales = array(
                ...
                // 'payment_type'                   => $data->sales->payment_method,
                'Bank_Account'                   => $data->sales->bank_name,
    ...
    public function getSalesRecord()
    {
        ...
        $sales = $this->db->query("
            select 
                (sm.SaleMaster_PaidAmount + sm.SaleMaster_BankPaidAmount) as paid_amount,
                sm.*,
                c.Customer_Code,
                c.Customer_Name,
                c.Customer_Mobile,
...
<?php
    ...
    public function getShipCustomers()
    {
        $res = $this->db->query("SELECT SaleMaster_SlNo,shipping_cus_name,shipping_mobile,shipping_address
        FROM tbl_salesmaster
        WHERE Status = 'a'
        and SaleMaster_branchid = ?", $this->sbrunch)->result();
