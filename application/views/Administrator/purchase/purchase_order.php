...
<div class="row" id="purchase">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			...
			<div class="form-group">
				<label class="col-sm-1 control-label no-padding" style="text-align: right;"> Purchase For </label>
				<div class="col-sm-2">
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input class="form-control" id="purchaseDate" name="purchaseDate" type="date" v-model="purchase.purchaseDate" v-bind:disabled="userType == 'u' ? true : false" style="border-radius: 5px 0px 0px 5px !important;padding: 4px 6px 4px !important;width: 150px;" />
				</div>
			</div>
		</div>
		<div class="row" style="margin-top:5px; margin-bottom:5px;">
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="text" v-model="purchase.memo_no" style="height:26px;" />
				</div>
			</div>
		</div>
	</div>
						...
						<div class="col-sm-12">
							<div class="table-responsive">
								<table style="color:#000;margin-bottom: 0px;">
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="number" id="freight" name="freight" class="form-control" v-model="purchase.freight" />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-12">
													<select v-model="purchase.payment_method" class="form-control" style="border-radius: 4px;padding:0px 4px;">
									...
									<tr style="display: none;" :style="{display: purchase.payment_method == 'Bank' ? '' : 'none'}">
										<td>
											<div class="form-group">
												<label class="col-xs-12 control-label no-padding-right">Bank Name</label>
												<div class="col-xs-12">
													<select v-model="purchase.bank_name" id="" class="form-control" style="border-radius: 4px;padding:0px 4px;">
														<option value="" disabled selected>Select</option>
	...
	new Vue({
		...
		methods: {
			...
			calculateTotal() {
				...
				this.purchase.total = ((parseFloat(this.purchase.subTotal) + parseFloat(this.purchase.vat)) - parseFloat(this.purchase.discount)).toFixed(2);
			...
			savePurchase() {
				...
				if (this.purchase.payment_method == '') {
					alert('Select Payment Method');
					return;
				}

				if (this.purchase.payment_method == 'Bank' && this.purchase.bank_name == '') {
