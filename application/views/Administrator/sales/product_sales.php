			...
			<div class="table-responsive">
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					...
					<tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
						...
						<tr>
							<td colspan="10">
								<textarea class="form-control" cols="30" rows="4" placeholder="Warrenty text here...." v-model="sales.warrenty"></textarea>
							</td>
						</tr>
					</tbody>
				</table>
							...
							<div class="table-responsive">
								<table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
											...
											<div class="row" style="margin: 0px 9px 5px;">
												<div class="col-xs-6" style="padding:0px;">
													<div class="form-check form-check-inline" style="padding: 0px;">
														<input class="form-check-input" type="checkbox" id="inlineCheckbox1" v-model="sales.shipping_due" value="1">
												...
												<div class="col-xs-6" style="padding:0px;">
													<div class="form-check form-check-inline" style="padding: 0px;text-align:right">
														<input class="form-check-input" type="checkbox" id="inlineCheckbox2" v-model="sales.shipping_paid" value="1">
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-7">
													<input type="number" id="vat" class="form-control" v-model="sales.vat" />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-5 control-label no-padding-right">Discount %</label>
												<div class="col-xs-7">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-5 control-label no-padding-right">Discount Tk</label>
												<div class="col-xs-7">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-5 control-label no-padding-right">Transp. Cost</label>
												<div class="col-xs-7">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-5 control-label no-padding-right">AIT Cost</label>
												<div class="col-xs-7">
													<input type="number" class="form-control" v-model="sales.aitCost" v-on:input="calculateTotal" />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-7">
													<input type="number" v-model="sales.bank_paid" id="bank_paid" class="form-control" v-on:input="calculateTotal" v-bind:disabled="selectedCustomer.Customer_Type == 'G' ? true : false" />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												<!-- <label class="col-xs-12 control-label no-padding-right">Bank Name</label> -->
												<div class="col-xs-12">
													<select v-bind:disabled="sales.bank_paid > 0 ? false : true" v-model="sales.bank_name" id="" class="form-control" style="border-radius: 4px;padding:0px 4px;">
		...
		methods: {
			...
			addToCart() {
				...
				let product = {
					...
					color_name: this.selectedProduct.color_name,
			...
			calculateTotal() {
				...
				this.sales.total = ((parseFloat(this.sales.subTotal) + parseFloat(this.sales.vat) + parseFloat(this.sales.transportCost) + parseFloat(this.sales.aitCost)) - parseFloat(this.sales.discount)).toFixed(2);
				...
				if (this.selectedCustomer.Customer_Type == 'G') {
					...
					this.sales.due = (parseFloat(this.sales.total) - parseFloat(this.sales.paid) - parseFloat(this.sales.bank_paid)).toFixed(2);
				}
			},
			async saveSales() {
				if (this.selectedCustomer.Customer_SlNo == '') {
				...
				if ((this.sales.bank_paid > 0) && (this.sales.bank_name == '')) {
			...
			async getSales() {
				await axios.post('/get_sales', {
					...
					this.sales.bank_name = sales.Bank_Account;
