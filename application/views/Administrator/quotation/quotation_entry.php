					...
					<div class="row">
						<div class="col-sm-5">
							<div class="form-group">
								...
								<div class="col-xs-7">
									<v-select v-bind:options="customers" label="display_name" v-model="selectedCustomer" v-on:input="onCustomerChange"></v-select>
								</div>
							...
							<div class="form-check form-check-inline" style="padding: 0px 13px;text-align:right">
								...
								<input class="form-check-input" type="checkbox" id="inlineCheckbox2" v-model="sameAddress">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" v-model="quotation.shipping_cus_name" required />
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right"> Mobile No </label>
								<div class="col-sm-8">
									<input type="text" class="form-control" v-model="quotation.shipping_mobile" required />
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right"> Address </label>
								<div class="col-sm-8">
									<textarea class="form-control" v-model="quotation.shipping_address" required></textarea>
								</div>
							</div>
						</div>
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr class="">
							...
							<th style="width:20%;color:#000;">Descriptio</th>
					...
					<tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
						...
						<tr>
							<td colspan="9" style="text-align: left;">
								...
								<textarea class="form-control" cols="30" rows="2" placeholder="Warrenty text here...." v-model="quotation.warrenty"></textarea>
							</td>
						</tr>
						<tr>
							<td colspan="9" style="text-align: left;">
								<label for=""><strong>Payment Note</strong></label>
								<textarea class="form-control" cols="30" rows="2" placeholder="Payment note here...." v-model="quotation.payment_note"></textarea>
							</td>
						</tr>
					</tbody>
				</table>
								...
								<table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-12">
													<input type="number" id="paid" class="form-control" v-model="quotation.paid" v-on:input="calculateTotal" readonly />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td style="padding: 10px 0 0 13px;">
											<div class="form-group">
												<input type="button" class="btn btn-default" value="Save" v-on:click="saveQuotation" style="color:#fff;margin-top: 0px;margin-right: 5px;">
	...
	new Vue({
		...
		methods: {
			...
			calculateTotal() {
				...
				this.quotation.total = ((parseFloat(this.quotation.subTotal) + parseFloat(this.quotation.vat) + parseFloat(this.quotation.transportCost)) - parseFloat(this.quotation.discount)).toFixed(2);
